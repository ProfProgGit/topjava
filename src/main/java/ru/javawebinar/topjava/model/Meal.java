...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = { Default.class, WebValidation.class  })
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = { Default.class, WebValidation.class  })
    private String description;

    @Column(name = "calories", nullable = false)
    @Min(value = 10L, groups = { Default.class, WebValidation.class  })
    @Max(value = 5000L, groups = { Default.class, WebValidation.class  })
    @NotNull(groups = { Default.class, WebValidation.class  })
